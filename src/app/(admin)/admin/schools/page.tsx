...
import { listSchoolsPage } from "@/server/services/admin-schools";
...
export default async function AdminSchoolsPage(
  ...
  const result = await listSchoolsPage({
    search: q,
    status: status as SchoolStatus | "ALL",
    page,
    pageSize: PAGE_SIZE,
  });
